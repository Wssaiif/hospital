...
public class AddDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_add_doctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String doctor_name_txt, doctor_specialty_txt;
                doctor_name_txt = doctor_name.getText().toString().trim();
                doctor_specialty_txt = doctor_specialty.getText().toString().trim();
                ...
                if (doctor_specialty_txt.equals("")) {
                    doctor_specialty.setError("This field is required");
                    flag = false;
                }
